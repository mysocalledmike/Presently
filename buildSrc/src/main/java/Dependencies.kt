object Versions {
    ...
    const val KOTLIN = "2.0.21" //https://developer.android.com/jetpack/androidx/releases/core
    const val KOTLIN_COROUTINES = "1.9.0" //https://github.com/Kotlin/kotlinx.coroutines/releases/
    const val KOTLIN_COROUTINES_TEST = "1.9.0"
    const val ANDROIDX_CORE_KTX = "1.15.0" //https://developer.android.com/jetpack/androidx/releases/core
    const val ANDROIDX_COMPAT = "1.7.0" //https://developer.android.com/jetpack/androidx/releases/appcompat
    const val ANDROIDX_CONSTRAINT = "2.2.0" //https://developer.android.com/jetpack/androidx/releases/constraintlayout
    const val ANDROIDX_LIFECYCLE = "2.8.7" //https://developer.android.com/jetpack/androidx/releases/lifecycle
    const val ANDROIDX_RECYCLER_VIEW = "1.3.2"
    const val FRAGMENT_TESTING = "1.8.5"
    const val ANDROIDX_BIOMETRIC = "1.4.0-alpha02" //https://developer.android.com/jetpack/androidx/releases/biometric
    const val ANDROIDX_TEST_JUNIT = "1.2.1"
    const val ANDROIDX_WORK = "2.10.0" //https://developer.android.com/jetpack/androidx/releases/work
    const val ANDROIDX_ROOM = "2.6.1" //https://developer.android.com/jetpack/androidx/releases/room
    const val ANDROIDX_PAGING = "3.3.4" //https://developer.android.com/jetpack/androidx/releases/paging
    const val ANDROIDX_FRAGMENT_KTX = "1.8.5" //https://developer.android.com/jetpack/androidx/releases/fragment
    const val ANDROIDX_TEST_CORE_KTX = "1.6.1"
    const val ANDROIDX_TEST_ESPRESSO = "3.6.1"
    const val ANDROIDX_TEST_RULES = "1.6.1"
    const val ANDROIDX_TEST_RUNNER = "1.6.2"
    const val ANDROIDX_TEST_UIAUTOMATOR = "2.3.0"
    const val ANDROIDX_PREF_KTX = "1.2.1"
    const val ANDROIDX_ARCH_CORE = "2.2.0" //https://developer.android.com/jetpack/androidx/releases/arch-core
    const val FIREBASE = "33.5.1" //https://firebase.google.com/support/release-notes/android
    const val DAGGER = "2.52" //https://github.com/google/dagger/releases
    const val HILT_ANDROID = "1.2.0" //https://developer.android.com/jetpack/androidx/releases/hilt
    ...
    const val MOCKITO_ANDROID = "5.14.2"
    const val ROBOLECTRIC = "4.13" //https://github.com/robolectric/robolectric/releases/
    const val TRUTH = "1.4.4"
    const val MAVERICKS = "3.0.9" //https://github.com/airbnb/mavericks/releases
    const val THREE_TEN_ABP = "1.4.7" //https://github.com/JakeWharton/ThreeTenABP/tags
    const val MATERIAL = "1.12.0"
    const val OSS_LICENSES = "17.1.0"
    const val COMPACT_CAL_VIEW = "3.0.0"
    const val APACHE = "1.12.0"
